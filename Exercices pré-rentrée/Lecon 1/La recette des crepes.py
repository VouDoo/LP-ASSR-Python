...
'La recette des crepes.py' : Ce programme permet d'afficher la recette des crepes en fonction d'un nombre de personne fourni par l'utilisateur
"""
...
nbr_personnnes = int(input()) # Nombre entier
...
if nbr_personnnes == 0 : # Si la valeur entree par l'utilisateur est nulle, on affiche un message d'erreur
    ...
    print("Pour", nbr_personnnes, "personnes il faut :")
