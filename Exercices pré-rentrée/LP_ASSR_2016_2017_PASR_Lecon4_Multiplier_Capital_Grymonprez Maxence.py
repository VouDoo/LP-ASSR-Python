...
def multiCapital(capitalInit, taux, coeff) :
    ...
    Entrees :
        ...
        - taux (float) : Taux d'interet annuel
...
print("""\
******************************
* Multiplier son capital !!! *
******************************\n
Ce programme retourne le nombre d'années nécessaires pour que le capital soit multiplié par un coefficient multiplicateur ainsi que le capital obtenu après ces années\n
Veuillez saisir les donnees suivantes :""")

# Saisie par l'utilisateur des differentes informations necessaires au calcul
capitalInit = int(input("\tCapital initial : ")) # Saisie du capital initial
tauxInteret = float(input("\tTaux d'interet annuel : ")) # Saisie du taux d'intérêt annuel
coeffMutlti = int(input("\tCoefficient multiplicateur : ")) # Saisie du coefficient multiplicateur
